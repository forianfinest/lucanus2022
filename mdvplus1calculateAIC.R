#! /usr/bin/Rscript
# Joana Meier
# edited by: Mattia De Vivo
# original script available at: https://speciationgenomics.github.io/fastsimcoal2/
...
k<-(grep("COMPLEX PARAMETERS",est)+1)-(grep("//all Ns are",est)+1)
